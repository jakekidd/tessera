...
<div style="width:100%;height:500px;border:1px solid #333;border-radius:4px;overflow:hidden;margin:16px 0">
  <iframe src="/tessera/demo/" style="width:100%;height:100%;border:none"></iframe>
</div>

[Open fullscreen](/tessera/demo/){target="_blank"}
...
Write tessera code on the left, see it render on the right. Choose from pre-written samples or write your own. Press **Ctrl+Enter** to run.

<div style="width:100%;height:500px;border:1px solid #333;border-radius:4px;overflow:hidden;margin:16px 0">
  <iframe src="/tessera/demo/sandbox.html" style="width:100%;height:100%;border:none"></iframe>
</div>

[Open fullscreen](/tessera/demo/sandbox.html){target="_blank"}
...
All tessera exports are in scope: `app`, `grid`, `Box`, `Row`, `Col`, `Text`, `Table`, `BarChart`, `LineGraph`, `BarGraph`, `Tabs`, `Button`, `palette`, `BoxChars`. `setInterval` is tracked for automatic cleanup.
